...
const queryExpansions: Record<string, string[]> = {
  ...
  plate: ["weight plate", "olympic plate", "iron plate", "bumper plate"],
  "weight plate": ["plate", "olympic plate", "iron plate", "bumper plate"],
  "olympic plate": ["weight plate", "plate"],
  "iron plate": ["weight plate", "plate"],
  "bumper plate": ["weight plate", "plate"],
  "ez bar": ["ez curl bar", "curl bar"],
  "ez-bar": ["ez bar", "ez curl bar", "curl bar"],
  "ez curl bar": ["ez bar", "curl bar"],
  "curl bar": ["ez bar", "ez curl bar"],
  "safety bar": ["safety squat bar", "ssb"],
  "safety squat bar": ["safety bar", "ssb"],
  ssb: ["safety bar", "safety squat bar"],
  "smith machine": ["smith"],
  smith: ["smith machine"],
  "slam ball": ["dead ball", "medicine ball slam"],
  "dead ball": ["slam ball"],
  sandbag: ["sand bag"],
  "sand bag": ["sandbag"],
};
