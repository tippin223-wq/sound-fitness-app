...
export const DASHBOARD_ROUTES = {
  ...
  achievements: route("/dashboard/achievements"),
  settings: route("/dashboard/settings"),
  help: route("/dashboard/help"),
...
export const ROUTES = {
  ...
  performance: PERFORMANCE_ROUTES,
...
export type AppRoute =
  ...
  | ValueOf<typeof PERFORMANCE_ROUTES>
