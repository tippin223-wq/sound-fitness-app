      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-120px)] max-w-7xl items-center gap-10 px-5 pb-12 sm:px-8 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="relative hidden lg:block">
          ...
          <h1 className="mt-7 max-w-2xl text-6xl font-black uppercase leading-[0.9] tracking-tight text-white">
            ...
            access.
            <br />
            <span className="text-sky-500">Keep going.</span>
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300">
            Enter the email connected to your Sound Fitness account and we’ll
            send instructions to help you get back into your member dashboard.
          </p>
          ...
          <div className="mt-8 grid max-w-xl gap-4">
            {[
              [
                "🔐",
                "Secure Reset",
                "Password recovery keeps your member data protected.",
              ],
              [
                "📩",
                "Email Instructions",
                "Use the email tied to your training account.",
              ],
              [
                "📈",
                "Progress Preserved",
                "Your workouts, messages, and history stay saved.",
              ],
            ].map(([icon, title, text]) => (
              <div
                key={title}
          ...
          <div className="relative">
            ...
            <div className="mt-8 border-t border-white/10 pt-5">
              <p className="text-center text-xs leading-6 text-slate-500">
                Having trouble? Contact your Sound Fitness coach for help
