  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(250,204,21,0.18),transparent_30%),radial-gradient(circle_at_top_right,rgba(34,211,238,0.18),transparent_30%),linear-gradient(180deg,#020617_0%,#0f172a_52%,#020617_100%)] text-white">
      ...
      <section className="mx-auto w-full max-w-[1240px] space-y-6 px-4 py-8">
        <section className="overflow-hidden rounded-[44px] border border-yellow-300/20 bg-[radial-gradient(circle_at_20%_0%,rgba(250,204,21,0.22),transparent_35%),radial-gradient(circle_at_85%_20%,rgba(34,211,238,0.2),transparent_32%),linear-gradient(135deg,rgba(15,23,42,0.96),rgba(2,6,23,0.98))] p-6 shadow-[0_30px_120px_rgba(0,0,0,0.7)] lg:p-8">
          <div className="grid gap-8 lg:grid-cols-[1fr_360px] lg:items-center">
            <div>
              ...
              <h1 className="mt-4 max-w-3xl text-4xl font-black leading-tight lg:text-6xl">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  ...
                  className="rounded-2xl bg-gradient-to-r from-yellow-300 to-yellow-500 px-5 py-3 text-sm font-black text-slate-950 shadow-[0_0_34px_rgba(250,204,21,0.28)] transition hover:scale-[1.02]"
                >
                  Add More Stats →
                </Link>
                ...
                <a
                  ...
                  target="_blank"
                  className="rounded-2xl border border-cyan-300/25 bg-cyan-400/10 px-5 py-3 text-sm font-black text-cyan-300 transition hover:bg-cyan-400 hover:text-slate-950"
                >
                  Share Progress ✦
                </a>
              </div>
        ...
        {summaries.length > 0 ? (
          <section className="grid gap-5 lg:grid-cols-2">
            {summaries.map((item) => (
              <article
                key={item.exerciseId}
                className="rounded-[36px] border border-white/10 bg-[linear-gradient(135deg,rgba(15,23,42,0.86),rgba(2,6,23,0.96))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.45)] transition hover:border-yellow-300/30"
              >
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-2xl border border-yellow-300/25 bg-yellow-400/10 px-4 py-3 text-sm font-black text-yellow-300 transition hover:bg-yellow-400 hover:text-slate-950"
                >
                  Copy Share Text ✦
                </button>
              </article>
          ...
          <section className="rounded-[36px] border border-white/10 bg-white/[0.05] p-10 text-center shadow-2xl">
            ...
            <Link
              href="/dashboard/workout-builder/exercise-library"
              className="mt-6 inline-flex rounded-2xl bg-gradient-to-r from-yellow-300 to-yellow-500 px-5 py-3 text-sm font-black text-slate-950"
            >
              Add First Stat →
            </Link>
          </section>
