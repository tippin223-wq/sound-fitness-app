      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-120px)] max-w-7xl items-center gap-10 px-5 pb-12 sm:px-8 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="relative hidden lg:block">
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300">
            Sign in to manage members, review sessions, assign workouts, update
            progress, and keep every client moving forward.
          </p>
          ...
          <div className="mt-8 grid max-w-xl gap-4">
            {[
              [
                "👥",
                "Member Management",
                "View member profiles, goals, notes, and training history.",
              ],
              [
                "🏋️",
                "Workout Tools",
                "Assign workouts, update plans, and review completed sessions.",
              ],
              [
                "📈",
                "Progress Review",
                "Track consistency, goals, check-ins, and training outcomes.",
              ],
              [
                "💬",
                "Coach Messaging",
                "Keep member communication organized and professional.",
              ],
            ].map(([icon, title, text]) => (
              <div
                key={title}
          ...
          <div className="relative">
            <div className="text-center">
              ...
              <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-400">
                Access your coaching dashboard and manage member progress.
              </p>
            </div>
            ...
            <div className="mt-8 border-t border-white/10 pt-5">
              <p className="text-center text-xs leading-6 text-slate-500">
                Coach access is restricted to approved Sound Fitness staff.
              </p>
            </div>
          </div>
        </section>
