...
export default function ProfileRewardOrbit() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative mt-4 h-20 cursor-grab [perspective:720px] active:cursor-grabbing"
      ...
      >
        {rewardItems.map((item, index) => {
          ...
          const x = 40 + distance * 82;
          const z = active ? 44 : -78;
          ...
          return (
            <button
              ...
              className="absolute left-1/2 top-1/2 h-16 w-16 -translate-x-1/2 -translate-y-1/2 p-0.5 transition-[opacity,transform,filter] duration-500 hover:drop-shadow-[0_0_22px_rgba(125,211,252,0.34)]"
              key={item.id}
